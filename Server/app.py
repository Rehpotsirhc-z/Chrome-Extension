...
text_model = BertForSequenceClassification.from_pretrained("bert-base-uncased", num_labels=8)

text_model.load_state_dict(torch.load("models/text/model.pth", map_location=torch.device("cpu")), strict=False)
text_model.eval()
